                ...
                <tr key={teacher.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="p-4">
                    <div className="flex items-center space-x-1">
                      ...
                      {teacher.rating && (
                        <span className="text-sm text-gray-500 ml-1">({teacher.rating})</span>
                      )}
                    </div>
                  </td>
                  <td className="p-4">
        ...
        {teachers.length > itemsPerPage && (
          <div className="flex justify-between items-center p-4 border-t">
            <div className="text-sm text-gray-600">
              {currentPage * itemsPerPage + 1}–{Math.min((currentPage + 1) * itemsPerPage, teachers.length)} / {teachers.length}
            </div>
            <div className="flex space-x-2">
              <button
